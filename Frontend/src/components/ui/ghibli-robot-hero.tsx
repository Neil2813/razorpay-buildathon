 ...
 */
const FONT_HREFS: string[] = [];

const SERIF = "'Antonio', sans-serif";
  ...
  return (
    ...
    >
      ...
      >
        {eyebrow ? (
          <p
            className="ghibli-robot-hero-rise mb-5 text-[13px] font-medium uppercase tracking-[0.18em] text-[var(--color-text-dark)] opacity-70"
            style={rise(0)}
          >
            {eyebrow}
          </p>
        ...
        <h1
          className="ghibli-robot-hero-rise max-w-[20ch] text-balance text-[clamp(2.5rem,7.4vw,5rem)] font-normal leading-[1.02] tracking-[-0.02em] text-[var(--color-primary-dark)]"
          style={{
            ...rise(1),
            fontFamily: SERIF,
          }}
        ...
        {subtitle ? (
          <p
            className="ghibli-robot-hero-rise mt-6 max-w-[86ch] text-pretty text-[clamp(1rem,1.5vw,1.175rem)] font-normal leading-relaxed text-[var(--color-text-dark)]"
            style={{
              ...rise(2),
            }}
          >
        ...
        >
          ...
          {note ? (
            <p
              className="text-[13px] text-[var(--color-text-dark)] opacity-70"
            >
              {note}
            </p>
          ) : null}
